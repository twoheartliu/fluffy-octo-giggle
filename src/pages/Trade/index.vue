  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="cell in detailArrayList"
          :key="cell.skuId"
        >
          <li>
            <img :src="cell.imgUrl" :alt="cell.skuName" />
          </li>
          <li class="skuName">
            <p>
              {{ cell.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo" v-show="userChosenAddress.id">
        寄送至:
        <span>{{ userChosenAddress.fullAddress }}</span>
        收货人：<span>{{ userChosenAddress.consignee }}</span>
        <span>{{ userChosenAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    changeDefault (item, addressList) {
      addressList.forEach(e => e.isDefault = '0')
      item.isDefault = '1'
    }
  }
}
