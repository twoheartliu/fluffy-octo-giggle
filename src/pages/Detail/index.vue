            ...
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd
                  ...
                  :key="value.id"
                  @click="changeAttrValue(value, attr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  autocomplete="off"
                  class="itxt"
                  v-model.lazy.trim.number="skuNum"
                  @change="skuNumChange"
                />
...
export default {
  ...
  mounted () {
    this.$store.dispatch('detail/getItemDetail', this.skuId)
  },
  computed: {
    ...mapGetters('detail', ['categoryView', 'skuInfo', 'spuSaleAttrList', 'valuesSkuJson', 'price'])
  },
  methods: {
    changeAttrValue (value, arr) {
      arr.forEach(e => {
        e.isChecked = '0'
      })
      value.isChecked = '1'
    ...
    async addToCart () {
      try {
        await this.$store.dispatch('detail/postAddToCart', { skuId: this.skuId, skuNum: this.skuNum })
